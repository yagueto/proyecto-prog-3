...
public class AutoCompleteJComboBox<E> extends PlainDocument {
    private final JComboBox<E> comboBox;
    private final ComboBoxModel<E> model;
    private final JTextComponent editor;
    private final boolean hidePopupOnFocusLoss;

    public AutoCompleteJComboBox(JComboBox<E> comboBox) {
        ...
        editor.addFocusListener(new FocusAdapter() {
            ...
            public void focusLost(FocusEvent e) {
                ...
                if (hidePopupOnFocusLoss) AutoCompleteJComboBox.this.comboBox.setPopupVisible(false);
            }
        });
        ...
        editor.addKeyListener(new KeyAdapter() {
            ...
            public void keyPressed(java.awt.event.KeyEvent e) {
                if (e.getKeyCode() == KeyEvent.VK_ENTER) {
                    ...
                    AutoCompleteJComboBox.this.comboBox.setSelectedIndex(0);
                    AutoCompleteJComboBox.this.editor.setText(Objects.requireNonNull(AutoCompleteJComboBox.this.comboBox.getSelectedItem()).toString());
                    highlightCompletedText(0);
                }
            }
        });
    ...
    public void insertString(int offs, String str, AttributeSet a) throws BadLocationException {
        ...
        // if the user selects an item via mouse the whole string will be inserted.
